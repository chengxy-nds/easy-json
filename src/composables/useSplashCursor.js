// SplashCursor — WebGL 流体光标特效
// 从 React Bits 的 SplashCursor 移植为 Vue 3 版本
// 原始项目: https://reactbits.dev
 ...
 */
export function useSplashCursor(canvas, configOverrides = {}) {
  // ── 默认配置 ──
  const config = {
    SIM_RESOLUTION: 128,
    DYE_RESOLUTION: 1440,
  ...
  function generateColor() {
    ...
    // 多色混合：白、灰白、蓝灰、浅绿、浅蓝
    const palette = ['#ffffff', '#f0f0f4', '#c2ccd0', '#f3f9f1', '#f2fdff']
